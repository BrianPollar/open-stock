...
import {
  IcustomRequest, IdataArrayResponse, IfilterAggResponse, IfilterProps, IreviewMain
...
reviewRoutes.get('/one/:urIdOr_id', async(req: IcustomRequest<{ urIdOr_id: string }, null>, res) => {
