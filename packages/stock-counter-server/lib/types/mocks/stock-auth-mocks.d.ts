...
export declare const createMockUser: (incrementor?: number) => Iuser;
...
export declare const createMockUsers: (length: any) => Iuser[];
export declare const createMockCompany: (incrementor?: number) => Icompany;
export declare const createMockCompanys: (length?: number) => Icompany[];
