...
import { createMockSalesReport } from '../../../../../mocks';
...
import { salesReportRoutes } from '../../../../../../stock-counter-server/src/routes/printables/report/salesreport.routes';
...
describe('salesreport', () => {
  ...
  beforeAll(async() => {
    ...
    app.use(apiUrl, salesReportRoutes);
  ...
  it('should create one given the right data type', async() => {
    const body = {
      salesReport: createMockSalesReport()
    };
    delete body.salesReport['_id'];
