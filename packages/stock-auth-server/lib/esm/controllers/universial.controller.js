...
export const setUserInfo = (userId, permissions) => {
    const details = {
        userId,
        permissions
    };
...
export const validatePhone = async (userId, nowCase, verifycode, newPassword) => {
...
export const validateEmail = async (userId, type, nowCase, verifycode, newPassword) => {
...
export const sendTokenEmail = (app, foundUser, type, appOfficialName) => new Promise(resolve => {
