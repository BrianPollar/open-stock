...
const createMockExpenseReport = (incrementor = 0) => {
    ...
    return new expensereport_define_1.ExpenseReport(report);
};
...
const createMockInvoiceReport = () => {
    ...
    return new invoicereport_define_1.InvoiceReport(report);
};
...
const createMockProfitAndLossReport = () => {
    ...
    return new profitandlossreport_define_1.ProfitAndLossReport(report);
};
...
const createMockSalesReport = () => {
    ...
    return new salesreport_define_1.SalesReport(report);
};
...
const createMockTaxReport = () => {
    ...
    return new taxreport_define_1.TaxReport(report);
};
...
const createMockSettingsGeneral = () => {
    return {
        ...
        defaultDigitalName: en_US_1.faker.image.avatar()
    };
};
...
const createMockSettingsTax = () => ({
    enabled: false,
    defaultType: 'string',
    vatPercentage: en_US_1.faker.number.int(2),
    incomePercentage: en_US_1.faker.number.int(2),
    itemsBulkPercentage: en_US_1.faker.number.int(2),
    gstinNo: en_US_1.faker.string.alphanumeric(7),
    taxes: []
});
...
const createMockInvoiceSettings = () => {
    ...
    return new invoicesetting_define_1.InvoiceSettings(settings);
};
...
const createMockDeliveryCity = () => {
    ...
    return new delivery_define_1.DeliveryCity(city);
};
...
const createMockDeliverynote = () => {
    ...
    return new deliverynote_define_1.DeliveryNote(note);
};
...
const createMockEstimate = () => {
    ...
    return new estimate_define_1.Estimate(estimate);
};
...
const createMockExpense = (incrementor = 0) => {
    return new expense_define_1.Expense((0, exports.mockExpense)(incrementor));
};
...
const createMockFaq = () => {
    ...
    return new faq_define_1.Faq(faq);
};
...
const createMockInvoiceRelated = () => {
    return new receipt_define_1.InvoiceRelated((0, exports.createMockInvoiceRelatedSolo)());
};
exports.createMockInvoiceRelated = createMockInvoiceRelated;
/** The  createMockInvoiceRelated  function creates a new instance of the  InvoiceRelated  class by passing the mock invoice-related object generated by the  createMockInvoiceRelatedSolo  function. */
const createMockInvoiceRelatedWithReceipt = () => {
    return new invoice_define_1.InvoiceRelatedWithReceipt((0, exports.createMockInvoiceRelatedSolo)());
};
...
const createMockInvoice = () => {
    ...
    return new invoice_define_1.Invoice(invoice);
};
...
const createMockItem = (incrementor = 0) => {
    ...
    return new item_define_1.Item(item);
};
...
const createMockItemDecoy = () => {
    ...
    return new itemdecoy_define_1.ItemDecoy(decoy);
};
...
const createMockItemOffer = () => {
    ...
    return new itemoffer_define_1.ItemOffer(offer);
};
...
const createMockOrder = () => {
    ...
    return new order_define_1.Order(order);
};
...
const createMockPaymentRelated = () => {
    return new payment_define_1.PaymentRelated((0, exports.createMockPaymentRelatedSolo)());
};
...
const createMockProfit = () => {
    ...
    return new profit_define_1.Profit(profit);
};
...
const createMockReceipt = () => {
    ...
    return new receipt_define_1.Receipt(receipt);
};
...
const createMockReview = () => {
    ...
    return new review_define_1.Review(review);
};
...
const createMockCustomer = () => {
    ...
    return new src_1.Customer(customer);
};
