import { Iaddress, IdatabaseAuto, ItrackStamp, Iuser } from './general-types';
...
extends IdatabaseAuto, ItrackStamp, IurId, Partial<IcompanyId> {
  companyId?: string;
  user: string | Iuser;
  startDate: Date;
  endDate: Date;
...
// part of our big data effort
export interface IuserBehaviour
extends IdatabaseAuto {
  ...
  searchTerms: {term: string; filter: string}[];
  expireAt?: string;
}
