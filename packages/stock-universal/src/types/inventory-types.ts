...
extends IinvoiceRelated, IurId, Partial<IcompanyId> {
  estimateId: number;
  dueDate: Date;
}
...
extends IurId, Partial<IcompanyId>, ItrackStamp, IcurrencyProp {
  name: string;
  person: string;
  cost: number;
...
extends IurId, IcompanyId, ItrackStamp {
...
extends IurId, IcompanyId, ItrackStamp, IcurrencyProp {
  date: Date;
  totalAmount: number;
}
