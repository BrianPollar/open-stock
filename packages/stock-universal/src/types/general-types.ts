...
export interface IreviewMain
  extends IurId, Partial<IcompanyId> {
  image?: string;
  name: string;
  email: string;
  comment: string;
...
extends IurId, Partial<IcompanyId>, ItrackStamp {
...
extends IinvoiceRelated, IurId, Partial<IcompanyId>, ItrackStamp {
  payType?: TpayType;
  companyId?: string;
...
extends IdatabaseAuto, IcurrencyProp, IurId {
...
export interface IfilterProps {
  ...
  propSort?: IpropSort;
  returnEmptyArr?: boolean; // return only count as data is not neccesary
}
