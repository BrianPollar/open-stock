 ...
 */
export type TitemType = 'laptop' | 'desktop' | 'accessory' | string;
/**
 ...
 */
export type TorderStatus = 'pending' | 'paidNotDelivered' | 'delivered' | 'paidAndDelivered' | 'processing' | 'canceled';
/**
 ...
 */
export type TinvoiceStatus = 'paid' | 'pending' | 'overdue' | 'draft' | 'unpaid' | 'cancelled';
/**
 ...
 */
export type TpayType = 'nonSubscription' | 'subscription';
/**
 * Represents a union type for role authorization.
 * @typedef {('orders' | 'payments' | 'users' | 'items' | 'faqs' | 'videos' | 'printables' | 'buyer')} TroleAuth
 */
export type TroleAuth<T = 'orders'> = 'orders' | 'payments' | 'users' | 'items' | 'faqs' | 'buyer' | 'customers' | 'staffs' | 'estimates' | 'invoices' | 'decoys' | 'offers' | 'jobCards' | 'deliveryNotes' | 'receipts' | 'expenses' | 'reports' | 'companyProfile' | 'mails' | 'subscriptions' | 'deliveryCitys' | 'viewTrackStamp' | T;
/**
