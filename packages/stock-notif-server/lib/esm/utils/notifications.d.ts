 ...
 */
export declare const verifyAuthyToken: (phone: string, countryCode: string, code: string) => Promise<unknown>;
/**
 ...
 */
export declare const updateNotifnViewed: (user: Iauthtoken, _id: string) => Promise<boolean>;
/**
