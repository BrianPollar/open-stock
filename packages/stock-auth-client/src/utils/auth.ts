...
export class AuthController {
  ...
  googleLogin() {
    ...
    const observer$ = StockAuthClient.ehttp
      .makeGet<Iauthresponse>('/user/login/google');
  ...
  facebookLogin() {
    ...
    const observer$ = StockAuthClient.ehttp
      .makeGet<Iauthresponse>('/user/login/facebook');
  ...
  login<T = 'eUser'>(userInfo:
    ...
    const observer$ = StockAuthClient.ehttp.makePost<Iauthresponse>(
      '/user/login',
      { emailPhone: userInfo.emailPhone, passwd: userInfo.password, userType: userInfo.userType }
    );
  ...
  signup<T = 'eUser'>(userInfo:
    ...
    StockAuthClient.logger.debug(
      'AuthService:signup:: - signupUrl : %s, email: %email',
      '/user/signup',
      userInfo.emailPhone
    );
    const observer$ = StockAuthClient.ehttp
      .makePost<Iauthresponse>('/user/signup', details);
  ...
  recover(userInfo:
    ...
    const observer$ = StockAuthClient.ehttp
      .makePost<Iauthresponse>('/user/recover', userInfo);
