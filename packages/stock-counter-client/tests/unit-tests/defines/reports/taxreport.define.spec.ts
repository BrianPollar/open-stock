...
import { createMockTaxReport, createMockTaxReports } from '../../../../../tests/mocks';
...
describe('Environment', () => {
  ...
  it('#getTaxReports static should get TaxReports array', async() => {
    ...
    const list = await TaxReport.getTaxReports('/', 0, 0);
  ...
  it('#getOneTaxReport static should get one TaxReport', async() => {
    ...
    const one = await TaxReport.getOneTaxReport('urId');
  ...
  it('#addTaxReport static should add one TaxReport', async() => {
    ...
    const added = await TaxReport.addTaxReport(createMockTaxReport() as ItaxReport);
  ...
  it('#deleteTaxReports static should delete many TaxReports', async() => {
    ...
    const deleted = await TaxReport.deleteTaxReports(['ids']);
